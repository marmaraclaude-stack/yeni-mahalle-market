...
const TOC = [
  ...
  { id: "veriler", label: "İşlenen kişisel veriler" },
  { id: "amaclar", label: "İşleme amaçları" },
  { id: "hukuki", label: "Hukuki sebepler" },
  { id: "aktarim", label: "Verilerin aktarılması" },
  { id: "saklama", label: "Saklama süresi" },
  { id: "haklar", label: "KVKK md. 11 haklarınız" },
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <strong>{BUSINESS.legalName}</strong>, KVKK kapsamında veri sorumlusu
        sıfatıyla hareket eder.
      </p>

      <h2 id="veriler">2. İşlenen kişisel veriler</h2>
      <ul>
        <li>
      ...
      <h2 id="amaclar">3. İşleme amaçları</h2>
      <ul>
        ...
        <li>Sipariş durumu hakkında bilgilendirme ve müşteri iletişimi,</li>
        <li>Fatura düzenlenmesi ve yasal yükümlülüklerin yerine getirilmesi,</li>
        <li>Açık rızanız olması halinde kampanya ve duyuru bildirimleri.</li>
      </ul>

      <h2 id="hukuki">4. Hukuki sebepler ve toplama yöntemi</h2>
      <p>
        ...
        yerine getirilmesi) ve md. 5/2-f (meşru menfaat) hukuki sebeplerine;
        pazarlama iletileri bakımından ise açık rızanıza dayanılarak toplanır
        ve işlenir.
      </p>
      ...
      <p>
        ...
        mevzuatta öngörülen süreler boyunca saklanır (örn. elektronik ticaret
        kayıtları için 3 yıl, fatura ve muhasebe kayıtları için 10 yıl).
        Sürelerin sonunda verileriniz silinir, yok edilir veya anonim hale
        getirilir.
      </p>
      ...
      <ul>
        ...
        <li>KVKK md. 7 çerçevesinde silinmesini veya yok edilmesini isteme,</li>
        <li>
          Düzeltme/silme işlemlerinin verilerin aktarıldığı üçüncü kişilere
          bildirilmesini isteme,
        </li>
        <li>
          Münhasıran otomatik sistemlerle analiz edilmesi suretiyle aleyhe bir
      ...
      <p>
        ...
        olarak{legal.email ? (
          <>
            {" "}
            veya <a href={`mailto:${legal.email}`}>{legal.email}</a> e-posta
            adresine
          </>
        ) : null}{" "}
      ...
      <h2 id="cerezler">8. Çerezler</h2>
      <p>
        Sitemizde, oturumunuzun açık kalması, sepetinizin hatırlanması ve
        temel site işlevleri için <strong>zorunlu çerezler</strong> kullanılır.
        Reklam veya üçüncü taraf takip çerezi kullanılmaz. Tarayıcınızın
        ayarlarından çerezleri dilediğiniz zaman silebilirsiniz; zorunlu
        çerezler engellenirse sepet ve üyelik işlevleri çalışmayabilir.
      </p>

      <h2 id="degisiklik">9. Değişiklikler</h2>
      <p>
